...
user_input = input()
print(user_input)
print("1) select a or b""\n"
      "A. Expend energy, enjoy groups.			 B. Conserve energy, one-on-one")
user_input = input()
print("2) select a or b""\n"
      "A. Interpret literally. 			 B. Look for meaning and possibilities")
user_input = input()
print("3) select a or b""\n"
      "A. Logical, thinking, questioning. 			 B. Empathetic, feeling, accommodating")
user_input = input()
print("4) select a or b""\n"
      "A. Organized, orderly. 			 B. Flexible, adaptable")
user_input = input()
print("5) select a or b""\n"
      "A. More outgoing, think out loud. 			 B. More reserved, think to yourself.")
user_input = input()
print("6) select a or b""\n"
      "A. Practical, realistic, experiential. 			 B. Imagination, innovative, theoretical.")
user_input = input()
print("7) select a or b""\n"
      "A. Candid, straight forward, frank. 			 B. Tactful, kind, encouraging.")
user_input = input()
print("8) select a or b""\n"
      "A. Plan, schedule. 			 B. Unplanned, spontaneous")
user_input = input()
print("9) select a or b""\n"
      "A. seek many tasks, public activities, interaction with others. 			 B. seek private, solitary activities "
      "with quiet to concentrate.")
user_input = input()
print("10) select a or b""\n"
      "A. standard, usual, conventional. 			 B. different, novel, unique.")
user_input = input()
print("11) select a or b""\n"
      "A. firm, tend to criticize, hold the line. 			 B. gentle, tend to appreciate, conciliate.")
user_input = input()
print("12) select a or b""\n"
      "A.regulated, structured. 			 B. easygoing, live  and let live")
user_input = input()
print("13) select a or b""\n"
      "A. external, communicative, express yourself. 			 B. internal, reticent, keep to yourself.")
user_input = input()
print("14) select a or b""\n"
      "A. focus on here-and-now. 			 B. look to the future, global perspective, big picture")
user_input = input()
print("15) select a or b""\n"
      "A. tough minded, just. 			 B. tender-hearted, merciful")
user_input = input()
print("16) select a or b""\n"
      "A. preparation, plan ahead. 			 B. go with the flow, adapt as you go.")
user_input = input()
print("17) select a or b""\n"
      "A. active, initiate.       B. reflective, deliberate")
user_input = input()
print("18) select a or b""\n"
      "A. facts, things, what is			 B. ideas, dreams, 'what could be', philosophical")
user_input = input()
print("19) select a or b""\n"
      "A. matter of fact, issue oriented 			 B. sensitive, people-oriented, compassionate")
user_input = input()
print("20) select a or b""\n"
      "A. control, govern 			 B. latitude, freedom")
user_input = input()

""" ENFJ:
    ENFJ personalites A ENTJ (ENFJ) is a person with the Extraverted, Intuitive, Feeling, and Judging personality
traits. These warm, forthright types love helping others, and they tend to have strong ideas and values. They back
their perspective with the creative energy to achieve their goals.
...
""" ENFP:
        A ENFP (ENFP) is someone with the Extraverted, Intuitive, Feeling, and Prospecting personality traits. These 
people tend to embrace big ideas and actions that reflect their sense of hope and goodwill toward others. Their 
vibrant energy can flow in many directions.
...
"""ENTJ: ENTJ personalities A (ENTJ) is someone with the Extraverted, Intuitive, Thinking, and Judging personality 
traits. They are decisive people who love momentum and accomplishment. They gather information to construct their 
creative visions but rarely hesitate for long before acting on them. If there’s anything ENTJs love,it’s a good 
challenge, big or small, and they firmly believe that given enough time and resources, they can achieve any goal. 
This quality makes people with the Commander personality type brilliant entrepreneurs, and their ability to think 
strategically and hold a long-term focus while executing each step of their plans with determination and precision 
...
ENTP personalities
    ...
    An (ENTP) is a person with the Extraverted, Intuitive, Thinking, and Prospecting personality traits. They tend to
...
"""ISFP: An ISFP (ISFP) is a person with the Introverted, Observant, Feeling, and Prospecting personality traits. 
They tend to have open minds, approaching life, new experiences, and people with grounded warmth. Their ability to 
stay in the moment helps them uncover exciting potentials.
...
""" ESTP:
        An ESTP ESTP is someone with the Extraverted, Observant, Thinking, and Prospecting personality traits. They 
tend to be energetic and action-oriented, deftly navigating whatever is in front of them. They love uncovering life’s 
...
""" ESFP:
        An ESFP ESFP is a person with the Extraverted, Observant, Feeling, and Prospecting personality traits. These 
...
""" ISTP:
        ISTP is someone with the Introverted, Observant, Thinking, and Prospecting personality traits. They tend to 
have an individualistic mindset, pursuing goals without needing much external connection. They engage in life with 
...
""" ISTJ:
        ISTJ A Logistician (ISTJ) is someone with the Introverted, Observant, Thinking, and Judging personality traits. 
These people tend to be reserved yet willful, with a rational outlook on life. They compose their actions carefully 
and carry them out with methodical purpose.
...
""" ISFJ: 
        A ISFJ () is someone with the Introverted, Observant, Feeling, and Judging personality traits. These people 
tend to be warm and unassuming in their own steady way. They’re efficient and responsible, giving careful attention 
...
""" INTJ:
        INTJ pesonality type An INTJ is a person with the Introverted, Intuitive, Thinking, and Judging personality 
traits. These thoughtful tacticians love perfecting the details of life, applying creativity and rationality to 
...
""" INTP:
        INTP personalities A (INTP) is someone with the Introverted, Intuitive, Thinking, and Prospecting personality 
traits. These flexible thinkers enjoy taking an unconventional approach to many aspects of life. They often seek out 
unlikely paths, mixing willingness to experiment with personal creativity. INTP often lose themselves in thought – 
...
""" INFP:
        A  (INFP) is someone who possesses the Introverted, Intuitive, Feeling, and Prospecting personality traits. 
...
""" INFJ:
        An Advocate (INFJ) is someone with the Introverted, Intuitive, Feeling, and Judging personality traits. They 
tend to approach life with deep thoughtfulness and imagination. Their inner vision, personal values, and a quiet, 
